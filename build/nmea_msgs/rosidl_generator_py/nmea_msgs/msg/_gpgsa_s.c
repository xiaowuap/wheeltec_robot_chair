...
bool nmea_msgs__msg__gpgsa__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nmea_msgs.msg._gpgsa.Gpgsa", full_classname_dest, 26) == 0);
  }
  nmea_msgs__msg__Gpgsa * ros_message = _ros_message;
  {  // header
  ...
  {  // sv_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "sv_ids");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->sv_ids.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sv_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * nmea_msgs__msg__gpgsa__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nmea_msgs.msg._gpgsa");
  ...
  {  // sv_ids
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "sv_ids");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->sv_ids.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->sv_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->sv_ids.size * sizeof(uint8_t));
      assert(data != NULL);
