...
static const _Gpgsa_type_support_symbol_names_t _Gpgsa_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nmea_msgs, msg, Gpgsa)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nmea_msgs, msg, Gpgsa)),
  }
};
...
{
  return &::nmea_msgs::msg::rosidl_typesupport_cpp::Gpgsa_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nmea_msgs, msg, Gpgsa)() {
  return get_message_type_support_handle<nmea_msgs::msg::Gpgsa>();
}
