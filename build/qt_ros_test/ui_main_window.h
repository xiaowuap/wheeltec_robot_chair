...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(672, 507);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 272, 568));
        ...
        verticalSpacer = new QSpacerItem(248, 27, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_6->addItem(verticalSpacer);

        horizontalLayout_15 = new QHBoxLayout();
        horizontalLayout_15->setObjectName(QString::fromUtf8("horizontalLayout_15"));
        checkBox_key = new QCheckBox(scrollAreaWidgetContents_3);
        checkBox_key->setObjectName(QString::fromUtf8("checkBox_key"));

        horizontalLayout_15->addWidget(checkBox_key);

        checkBox_mec = new QCheckBox(scrollAreaWidgetContents_3);
        ...
        pushButton_lu = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_u = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_ru = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_l = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_stop = new QPushButton(scrollAreaWidgetContents_3);
        pushButton_stop->setObjectName(QString::fromUtf8("pushButton_stop"));
        pushButton_stop->setAutoExclusive(true);

        gridLayout_2->addWidget(pushButton_stop, 1, 1, 1, 1);

        pushButton_r = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_ld = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_d = new QPushButton(scrollAreaWidgetContents_3);
        ...
        pushButton_rd = new QPushButton(scrollAreaWidgetContents_3);
        ...
        horizontalSlider_v = new QSlider(scrollAreaWidgetContents_3);
        ...
        label_v = new QLabel(scrollAreaWidgetContents_3);
        ...
        horizontalSlider_c = new QSlider(scrollAreaWidgetContents_3);
        ...
        label_c = new QLabel(scrollAreaWidgetContents_3);
        ...
        quit_button = new QPushButton(scrollAreaWidgetContents_3);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 221, 789));
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_12->setText(QApplication::translate("MainWindowDesign", "wheeltec@wheeltec", nullptr));
