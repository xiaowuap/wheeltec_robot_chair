...
static const _PointArray_type_support_symbol_names_t _PointArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheeltec_rrt_msg, msg, PointArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wheeltec_rrt_msg, msg, PointArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wheeltec_rrt_msg, msg, PointArray)() {
  return &::wheeltec_rrt_msg::msg::rosidl_typesupport_c::PointArray_message_type_support_handle;
}
