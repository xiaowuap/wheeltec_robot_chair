...
static const _Lockedcharrgb_type_support_symbol_names_t _Lockedcharrgb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bodyreader_msg, msg, Lockedcharrgb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bodyreader_msg, msg, Lockedcharrgb)),
  }
};
...
{
  return &::bodyreader_msg::msg::rosidl_typesupport_cpp::Lockedcharrgb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bodyreader_msg, msg, Lockedcharrgb)() {
  return get_message_type_support_handle<bodyreader_msg::msg::Lockedcharrgb>();
}
