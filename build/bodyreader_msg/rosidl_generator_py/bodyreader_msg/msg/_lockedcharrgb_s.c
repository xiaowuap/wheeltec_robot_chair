...
bool bodyreader_msg__msg__lockedcharrgb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyreader_msg.msg._lockedcharrgb.Lockedcharrgb", full_classname_dest, 47) == 0);
  }
  bodyreader_msg__msg__Lockedcharrgb * ros_message = _ros_message;
  {  // r
...
{
  /* NOTE(esteve): Call constructor of Lockedcharrgb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyreader_msg.msg._lockedcharrgb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Lockedcharrgb");
