...
{
  new (message_memory) bodyreader_msg::msg::Joint(_init);
}

void Joint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bodyreader_msg::msg::Joint *>(message_memory);
  typed_message->~Joint();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Joint_message_member_array[3] = {
  {
    ...
    offsetof(bodyreader_msg::msg::Joint, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bodyreader_msg::msg::Vector2f>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(bodyreader_msg::msg::Joint, depthposition),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bodyreader_msg::msg::Joint, worldposition),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Joint_message_members = {
  ...
  "Joint",  // message name
  3,  // number of fields
  sizeof(bodyreader_msg::msg::Joint),
...
{
  return &::bodyreader_msg::msg::rosidl_typesupport_introspection_cpp::Joint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bodyreader_msg, msg, Joint)() {
  return &::bodyreader_msg::msg::rosidl_typesupport_introspection_cpp::Joint_message_type_support_handle;
}
