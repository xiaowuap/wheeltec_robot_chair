...
#include "bodyreader_msg/msg/detail/joint__rosidl_typesupport_fastrtps_c.h"
...
#include "bodyreader_msg/msg/detail/vector2f__functions.h"  // depthposition
#include "bodyreader_msg/msg/detail/vector3f__functions.h"  // worldposition
...
using _Joint__ros_msg_type = bodyreader_msg__msg__Joint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: depthposition
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, bodyreader_msg, msg, Vector2f
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->depthposition, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_bodyreader_msg__msg__Vector2f(
...
static uint32_t _Joint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bodyreader_msg__msg__Joint(
  ...
  size_t current_alignment)
{
  ...
  // member: depthposition
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_bodyreader_msg__msg__Vector2f(
  ...
  if (is_plain) {
    ...
    using DataType = bodyreader_msg__msg__Joint;
    is_plain =
      (
...
static size_t _Joint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_bodyreader_msg__msg__Joint(
