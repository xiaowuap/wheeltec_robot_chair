...
echo_and_run cd "/home/wheeltec/wheeltec_robot/src/vision_opencv-noetic/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/wheeltec/wheeltec_robot/build/vision_opencv-noetic/cv_bridge \
    build --build-base "/home/wheeltec/wheeltec_robot/build/vision_opencv-noetic/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
