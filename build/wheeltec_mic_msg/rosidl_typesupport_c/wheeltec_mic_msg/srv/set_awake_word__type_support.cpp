...
static const _SetAwakeWord_Request_type_support_symbol_names_t _SetAwakeWord_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheeltec_mic_msg, srv, SetAwakeWord_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wheeltec_mic_msg, srv, SetAwakeWord_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wheeltec_mic_msg, srv, SetAwakeWord_Request)() {
  return &::wheeltec_mic_msg::srv::rosidl_typesupport_c::SetAwakeWord_Request_message_type_support_handle;
}
...
static const _SetAwakeWord_Response_type_support_symbol_names_t _SetAwakeWord_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheeltec_mic_msg, srv, SetAwakeWord_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wheeltec_mic_msg, srv, SetAwakeWord_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wheeltec_mic_msg, srv, SetAwakeWord_Response)() {
  return &::wheeltec_mic_msg::srv::rosidl_typesupport_c::SetAwakeWord_Response_message_type_support_handle;
}
...
static const _SetAwakeWord_type_support_symbol_names_t _SetAwakeWord_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wheeltec_mic_msg, srv, SetAwakeWord)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wheeltec_mic_msg, srv, SetAwakeWord)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, wheeltec_mic_msg, srv, SetAwakeWord)() {
  return &::wheeltec_mic_msg::srv::rosidl_typesupport_c::SetAwakeWord_service_type_support_handle;
}
