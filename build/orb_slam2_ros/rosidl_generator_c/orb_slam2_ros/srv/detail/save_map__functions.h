...
#ifndef ORB_SLAM2_ROS__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
#define ORB_SLAM2_ROS__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
 ...
 * calls
 * orb_slam2_ros__srv__SaveMap_Request__init().
...
/**
 * It calls
 * orb_slam2_ros__srv__SaveMap_Request__fini()
 ...
 * orb_slam2_ros__srv__SaveMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * orb_slam2_ros__srv__SaveMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * orb_slam2_ros__srv__SaveMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_orb_slam2_ros
...
/**
 * It calls
 * orb_slam2_ros__srv__SaveMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_orb_slam2_ros
...
/**
 * It allocates the memory for the array and calls
 * orb_slam2_ros__srv__SaveMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_orb_slam2_ros
...
/**
 * It calls
 * orb_slam2_ros__srv__SaveMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ORB_SLAM2_ROS__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
