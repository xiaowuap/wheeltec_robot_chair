...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from orb_slam2_ros.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from orb_slam2_ros.srv._save_map import SaveMap_Request as Request
    from orb_slam2_ros.srv._save_map import SaveMap_Response as Response
