...
class CfgNAVX5(metaclass=Metaclass_CfgNAVX5):
    ...
    def __eq__(self, other):
        ...
        if self.mask2 != other.mask2:
            return False
        if any(self.reserved1 != other.reserved1):
            return False
        ...
        if self.ini_fix3d != other.ini_fix3d:
            return False
        if any(self.reserved3 != other.reserved3):
            return False
        ...
        if self.sig_atten_comp_mode != other.sig_atten_comp_mode:
            return False
        if any(self.reserved4 != other.reserved4):
            return False
        if self.use_ppp != other.use_ppp:
            return False
        if self.aop_cfg != other.aop_cfg:
            return False
        if any(self.reserved5 != other.reserved5):
            return False
        if self.aop_orb_max_err != other.aop_orb_max_err:
            return False
        if any(self.reserved6 != other.reserved6):
            return False
