...
struct FindRoomSequenceWithCheckpointsResult_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ipa_building_msgs::RoomSequence_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ipa_building_msgs::RoomSequence_<ContainerAllocator> >> _checkpoints_type;
