...
struct MapSegmentationResult_
{
  ...
  _map_origin_type map_origin;
   ...
   typedef std::vector< ::ipa_building_msgs::RoomInformation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ipa_building_msgs::RoomInformation_<ContainerAllocator> >> _room_information_in_pixel_type;
  _room_information_in_pixel_type room_information_in_pixel;

   typedef std::vector< ::ipa_building_msgs::RoomInformation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ipa_building_msgs::RoomInformation_<ContainerAllocator> >> _room_information_in_meter_type;
  _room_information_in_meter_type room_information_in_meter;

   typedef std::vector< ::geometry_msgs::Point32_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Point32_<ContainerAllocator> >> _doorway_points_type;
