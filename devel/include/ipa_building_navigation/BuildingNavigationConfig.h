...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("tsp_solver", "int", 0, "TSP solver", "{'enum': [{'name': 'NearestNeighbor', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Use the nearest neighbor TSP algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'GeneticSolver', 'type': 'int', 'value': 2, 'srcline': 10, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Use the genetic TSP algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ConcordeSolver', 'type': 'int', 'value': 3, 'srcline': 11, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Use the Concorde TSP algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'TSP solver'}", &BuildingNavigationConfig::tsp_solver)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("problem_setting", "int", 0, "Problem setting of the sequence planning problem", "{'enum': [{'name': 'SimpleOrderPlanning', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Plan the optimal order of a simple set of locations.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CheckpointBasedPlanning', 'type': 'int', 'value': 2, 'srcline': 17, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Two-stage planning that creates local cliques of locations (= checkpoints) and determines the optimal order through the members of each clique as well as the optimal order through the cliques.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Problem setting of the sequence planning problem'}", &BuildingNavigationConfig::problem_setting)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("problem_setting", "int", 0, "Problem setting of the sequence planning problem", "{'enum': [{'name': 'SimpleOrderPlanning', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Plan the optimal order of a simple set of locations.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CheckpointBasedPlanning', 'type': 'int', 'value': 2, 'srcline': 17, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Two-stage planning that creates local cliques of locations (= checkpoints) and determines the optimal order through the members of each clique as well as the optimal order through the cliques.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Problem setting of the sequence planning problem'}", &BuildingNavigationConfig::problem_setting)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum': [{'name': 'DragTrolleyWhenNecessary', 'type': 'int', 'value': 1, 'srcline': 23, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Drag the trolley if it is too far away from next room.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition', 'type': 'int', 'value': 2, 'srcline': 24, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)'}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum': [{'name': 'DragTrolleyWhenNecessary', 'type': 'int', 'value': 1, 'srcline': 23, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Drag the trolley if it is too far away from next room.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition', 'type': 'int', 'value': 2, 'srcline': 24, 'srcfile': '/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)'}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_NearestNeighbor = 1;
//#line 10 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_GeneticSolver = 2;
//#line 11 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_ConcordeSolver = 3;
//#line 16 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_SimpleOrderPlanning = 1;
//#line 17 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_CheckpointBasedPlanning = 2;
//#line 23 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_DragTrolleyWhenNecessary = 1;
//#line 24 "/home/wheeltec/wheeltec_robot/src/ipa_exploration/ipa_building_navigation/cfg/BuildingNavigation.cfg"
