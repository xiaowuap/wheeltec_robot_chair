...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.color = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Params_colorConfig::AbstractParamDescriptionConstPtr(new Params_colorConfig::ParamDescription<int>("color", "int", 0, "chose present HSV thrshold", "{'enum': [{'name': 'Dynamic', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Use dynamic threshold', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Red', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Red', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Blue', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Blue', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Green', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Green', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Yellow', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Yellow', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Preset HSV threshold list'}", &Params_colorConfig::color)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Params_colorConfig::AbstractParamDescriptionConstPtr(new Params_colorConfig::ParamDescription<int>("color", "int", 0, "chose present HSV thrshold", "{'enum': [{'name': 'Dynamic', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Use dynamic threshold', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Red', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Red', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Blue', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Blue', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Green', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Green', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Yellow', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/wheeltec/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'description': 'Preset HSV threshold of Yellow', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Preset HSV threshold list'}", &Params_colorConfig::color)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.HSV_H_MIN = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
