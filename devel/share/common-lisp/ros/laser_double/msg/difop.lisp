...
(cl:defmethod cl:initialize-instance :after ((m <difop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'difop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_double-msg:<difop> is deprecated: use laser_double-msg:difop instead.")))

(cl:ensure-generic-function 'MotorSpeed-val :lambda-list '(m))
(cl:defmethod MotorSpeed-val ((m <difop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_double-msg:MotorSpeed-val is deprecated.  Use laser_double-msg:MotorSpeed instead.")
  (MotorSpeed m))
