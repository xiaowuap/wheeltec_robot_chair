...
col_green= (45,50,60,90,255,255)# green
...
def side_flag_callback(msg):
	...
	for boxes in msg.bounding_boxes:
		if boxes.Class == "turn" and boxes.probability > 0.5:
			if boxes.xmax < 320 and boxes.ymax > 220 and boxes.xmax > 30:
				side_flag = 1
			elif boxes.xmin > 320 and boxes.ymax > 220 and boxes.xmin < 610:
				side_flag = 2
		elif boxes.Class == "road_construction" and boxes.probability > 0.4:
