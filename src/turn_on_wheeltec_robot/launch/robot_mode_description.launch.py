...
def generate_launch_description():
    ...
    chair_diff_robot = LaunchConfiguration('chair_diff_robot', default='false')
    ...
    flagship_four_wheel_diff_dl_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.23835', '0.00002', '0.28466'], ['0', '0', '3.14'], 'base_footprint', 'laser'),
        generate_static_transform_publisher_node(['0.29014', '0.00024', '0.2122'], ['0', '0', '0'], 'base_footprint', 'camera_link'),    
    ]) 

    flagship_chair_diff_robot_ = GroupAction(
        condition=IfCondition(chair_diff_robot),
        actions=[
            #generate_robot_node('chair_diff_robot.urdf', 'chair_diff_robot'),
            generate_static_transform_publisher_node(['0.79', '0.25', '0'], ['-0.04', '0', '0'], 'base_footprint', 'laser1'),
            generate_static_transform_publisher_node(
                ['-1.0179', '-0.0347578', '-3.24913e-08'], ['0.0795887', '3.14159', '3.14159'], 'laser1', 'laser2'
            ),
            generate_static_transform_publisher_node(['0.185', '0', '0.11'], ['0', '0', '0'], 'base_footprint', 'camera_link'),
        ]
    )
    ...
    ld.add_action(flagship_chair_diff_robot_)
    return ld
