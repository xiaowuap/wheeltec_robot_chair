...
#include "wheeltec_rrt_msg/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wheeltec_rrt_msg::msg::PointArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wheeltec_rrt_msg::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wheeltec_rrt_msg::msg::PointArray *>(
    untyped_ros_message);
...
{
  return &wheeltec_rrt_msg::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
