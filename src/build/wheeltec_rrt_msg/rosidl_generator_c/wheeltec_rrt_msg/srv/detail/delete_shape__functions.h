...
#ifndef WHEELTEC_RRT_MSG__SRV__DETAIL__DELETE_SHAPE__FUNCTIONS_H_
#define WHEELTEC_RRT_MSG__SRV__DETAIL__DELETE_SHAPE__FUNCTIONS_H_
...
/// Initialize srv/DeleteShape message.
/**
...
/// Finalize srv/DeleteShape message.
/**
...
/// Create srv/DeleteShape message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wheeltec_rrt_msg__srv__DeleteShape_Request__init().
...
/// Destroy srv/DeleteShape message.
/**
 * It calls
 * wheeltec_rrt_msg__srv__DeleteShape_Request__fini()
...
/// Check for srv/DeleteShape message equality.
/**
...
/// Copy a srv/DeleteShape message.
/**
...
/// Initialize array of srv/DeleteShape messages.
/**
...
/// Finalize array of srv/DeleteShape messages.
/**
 * It calls
 * wheeltec_rrt_msg__srv__DeleteShape_Request__fini()
...
/// Create array of srv/DeleteShape messages.
/**
 * It allocates the memory for the array and calls
 * wheeltec_rrt_msg__srv__DeleteShape_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DeleteShape messages.
/**
 * It calls
 * wheeltec_rrt_msg__srv__DeleteShape_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DeleteShape message array equality.
/**
...
/// Copy an array of srv/DeleteShape messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wheeltec_rrt_msg__srv__DeleteShape_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wheeltec_rrt_msg
...
/**
 * It calls
 * wheeltec_rrt_msg__srv__DeleteShape_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_wheeltec_rrt_msg
...
/**
 * It allocates the memory for the array and calls
 * wheeltec_rrt_msg__srv__DeleteShape_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wheeltec_rrt_msg
...
/**
 * It calls
 * wheeltec_rrt_msg__srv__DeleteShape_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WHEELTEC_RRT_MSG__SRV__DETAIL__DELETE_SHAPE__FUNCTIONS_H_
