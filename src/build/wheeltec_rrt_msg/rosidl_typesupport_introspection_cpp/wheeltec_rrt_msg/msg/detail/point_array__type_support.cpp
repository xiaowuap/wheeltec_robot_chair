...
{
  new (message_memory) wheeltec_rrt_msg::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wheeltec_rrt_msg::msg::PointArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    offsetof(wheeltec_rrt_msg::msg::PointArray, points),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArray_message_members = {
  "wheeltec_rrt_msg::msg",  // message namespace
  "PointArray",  // message name
  1,  // number of fields
  sizeof(wheeltec_rrt_msg::msg::PointArray),
...
{
  return &::wheeltec_rrt_msg::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wheeltec_rrt_msg, msg, PointArray)() {
  return &::wheeltec_rrt_msg::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
