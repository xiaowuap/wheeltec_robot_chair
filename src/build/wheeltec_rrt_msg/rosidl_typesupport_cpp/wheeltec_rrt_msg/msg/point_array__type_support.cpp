...
static const _PointArray_type_support_symbol_names_t _PointArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wheeltec_rrt_msg, msg, PointArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wheeltec_rrt_msg, msg, PointArray)),
  }
};
...
get_message_type_support_handle<wheeltec_rrt_msg::msg::PointArray>()
{
  return &::wheeltec_rrt_msg::msg::rosidl_typesupport_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wheeltec_rrt_msg, msg, PointArray)() {
  return get_message_type_support_handle<wheeltec_rrt_msg::msg::PointArray>();
}
