...
bool wheeltec_rrt_msg__msg__point_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wheeltec_rrt_msg.msg._point_array.PointArray", full_classname_dest, 44) == 0);
  }
  wheeltec_rrt_msg__msg__PointArray * ros_message = _ros_message;
  {  // points
...
PyObject * wheeltec_rrt_msg__msg__point_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wheeltec_rrt_msg.msg._point_array");
