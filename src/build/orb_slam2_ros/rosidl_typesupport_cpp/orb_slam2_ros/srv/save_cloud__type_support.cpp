...
static const _SaveCloud_Request_type_support_symbol_names_t _SaveCloud_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveCloud_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orb_slam2_ros, srv, SaveCloud_Request)),
  }
};
...
{
  return &::orb_slam2_ros::srv::rosidl_typesupport_cpp::SaveCloud_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orb_slam2_ros, srv, SaveCloud_Request)() {
  return get_message_type_support_handle<orb_slam2_ros::srv::SaveCloud_Request>();
}
...
static const _SaveCloud_Response_type_support_symbol_names_t _SaveCloud_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveCloud_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orb_slam2_ros, srv, SaveCloud_Response)),
  }
};
...
{
  return &::orb_slam2_ros::srv::rosidl_typesupport_cpp::SaveCloud_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orb_slam2_ros, srv, SaveCloud_Response)() {
  return get_message_type_support_handle<orb_slam2_ros::srv::SaveCloud_Response>();
}
...
static const _SaveCloud_type_support_symbol_names_t _SaveCloud_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveCloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orb_slam2_ros, srv, SaveCloud)),
  }
};
...
{
  return &::orb_slam2_ros::srv::rosidl_typesupport_cpp::SaveCloud_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, orb_slam2_ros, srv, SaveCloud)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<orb_slam2_ros::srv::SaveCloud>();
}
