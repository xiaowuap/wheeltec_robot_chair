...
static const _GpgsvSatellite_type_support_symbol_names_t _GpgsvSatellite_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nmea_msgs, msg, GpgsvSatellite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nmea_msgs, msg, GpgsvSatellite)),
  }
};
...
{
  return &::nmea_msgs::msg::rosidl_typesupport_cpp::GpgsvSatellite_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nmea_msgs, msg, GpgsvSatellite)() {
  return get_message_type_support_handle<nmea_msgs::msg::GpgsvSatellite>();
}
